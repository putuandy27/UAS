...
@section('breadcrumbs')
<h1 class="h3 mb-2 text-gray-800">Hapus Data Handphone</h1>
<p class="mb-4">Berikut ini adalah fitur untuk menghapus data handphone yang ada di dalam database.</p>
@endsection
        ...
        <div class="col-10">
            <div class="card border-dark mb-3">
                ...
                <div class="card-body text-dark">
                    <p style="color:red" class="card-text">Berikut adalah detail handphone yang akan dihapus. Apakah anda yakin akan menghapusnya?</p>
                    <form action="/delete/{{ $handphones->id }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="harga" value=" {{ number_format($handphones->harga) }} " readonly>
                        </div>                        
                        <button type="submit" name="_method" value="delete" class="mt-3 btn btn-danger">Hapus!</button>
                    </form>
                </div>
            </div>
        </div> 
